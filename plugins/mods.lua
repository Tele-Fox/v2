...
send_msg('chat#id'..chat, 'unmuted '), ok_cb,  true)    end
    elseif msg.to.type == 'channel' then
send_msg('channel#id'..chat, 'unmuted '), ok_cb,  true)    end
end
end
...
local function mute_by_reply(extra, success, result)
    ...
    redis:set(hash, true)
    if msg.to.type == 'chat' then
send_msg('chat#id'..chat, 'muted '), ok_cb,  true)    end
    elseif msg.to.type == 'channel' then
send_msg('channel#id'..chat, 'muted '), ok_cb,  true)    end
    end
end
...
local function unmute_by_username(cb_extra, success, result)
    ...
    redis:del(hash)
    if chat_type == 'chat' then
send_msg('chat#id'..chat, 'unmuted '), ok_cb,  true)    elseif chat_type == 'channel' then
send_msg('channel#id'..chat, 'unmuted '), ok_cb,  true)    end
end
...
send_msg('chat#id'..chat, 'kicked. '), ok_cb,  true)
    elseif chat_type == 'channel' then
        channel_kick_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
send_msg('channel#id'..chat, 'kicked '), ok_cb,  true)
    end
end
...
local function chat_ban(extra, success, result)
    ...
    redis:set(hash, true)
    chat_del_user('chat#id'..chat, 'user#id'..user, ok_cb, false)
send_msg('chat#id'..chat, 'banned. '), ok_cb,  true)
end
...
local function gban_by_reply(extra, success, result)
    ...
    if msg.to.type == 'chat' then
        chat_del_user('chat#id'..chat, 'user#id'..user, ok_cb, false)
send_msg('chat#id'..chat, 'globallybanned.. '), ok_cb,  true)
    elseif msg.to.type == 'channel' then
        channel_kick_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
send_msg('channel#id'..chat, 'globallybanned. '), ok_cb,  true)
    end
end
...
send_msg('chat#id'..chat, 'ungloballybanned. '), ok_cb,  true)
    elseif msg.to.type == 'channel' then
        channel_invite_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
send_msg('channel#id'..chat, 'ungloballybanned.. '), ok_cb,  true)
    end
end
...
local function add_by_reply(extra, success, result)
    ...
    if msg.to.type == 'chat' then
        chat_add_user('chat#id'..chat, 'user#id'..user, ok_cb, false)
send_msg('chat#id'..chat, 'added.. '), ok_cb,  true)
    elseif msg.to.type == 'channel' then
        channel_invite_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
send_msg('channel#id'..chat, 'added.. '), ok_cb,  true)
    end
end
...
send_msg('channel#id'..chat, 'banned.. '), ok_cb,  true)
    ban_user(user, chat)
end
...
local function kick_by_username(cb_extra, success, result)
    ...
    user_username = result.username
    if chat_type == 'chat' then
send_msg('chat#id'..chat, 'user kicked.. '), ok_cb,  true)
        chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    elseif chat_type == 'channel' then
send_msg('channel#id'..chat, 'user kicked.. '), ok_cb,  true)
        channel_kick_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    end
end
...
local function unban_by_username(cb_extra, success, result)
    ...
    redis:del(hash)
    if chat_type == 'chat' then
send_msg('chat#id'..chat, 'unbanned.. '), ok_cb,  true)
        chat_add_user('chat#id'..chat_id, 'user#id'..user_id, callback, false)
    elseif chat_type == 'channel' then
send_msg('channel#id'..chat, 'unbanned.. '), ok_cb,  true)
...
send_msg('chat#id'..chat, 'globallybanned.. '), ok_cb,  true)
                    chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                elseif chat_type == 'channel' then
send_msg('channel#id'..chat_id, 'gpbanned.. '), ok_cb,  true)
                    channel_kick_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                end
                return
            end
